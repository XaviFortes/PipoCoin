...
"""Verify that starting pipocoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pipocoin with -h for help text")
        ...
        self.log.info("Start pipocoin with -version for version information")
