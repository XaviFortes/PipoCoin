...
const char * const BITCOIN_CONF_FILENAME = "pipocoin.conf";
const char * const BITCOIN_PID_FILENAME = "pipocoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pipocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pipocoin";
#else
    // Unix
    return pathRet / ".pipocoin";
#endif
#endif
}
