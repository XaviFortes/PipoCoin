...
#if defined(NDEBUG)
# error "Pipocoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Pipocoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PIPO additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("pipocoin-scriptch");
