...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pipocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pipocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pipocoin transaction") + "\n" +
              "  pipocoin-tx [options] -create [commands]   " + _("Create hex-encoded pipocoin transaction") + "\n" +
              "\n";
