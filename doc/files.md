...
* pipocoin.conf: contains configuration settings for pipocoind or pipocoin-qt
* pipocoind.pid: stores the process id of pipocoind while running
...
* debug.log: contains debug information and general logging generated by pipocoind or pipocoin-qt
