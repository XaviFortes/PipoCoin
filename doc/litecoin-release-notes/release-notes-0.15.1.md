Pipocoin Core version *0.15.1* is now available from:

  <https://download.pipocoin.org/pipocoin-0.15.1/>
...
A number of changes to the way Pipocoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 gambino per kB (0.00001 PIPO). This is to prepare for dropping the minimum transaction fee to 0.1 gambino per kB (0.0001 PIPO) in the next release.
